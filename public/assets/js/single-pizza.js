...
// GET request to allow users to see individual pizza and its discussion
function getPizza() {
  // get id of pizza
  ...
  fetch(`/api/pizzas/${pizzaId}`)
    ...
    .catch(err => {
      ...
      window.history.back(); // as long as a browser session has a previous page, it will behave as a "Back" button
    });
}
